    ...
    <div class="row">
        <div class="col-md-7">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="Nhập tên" value="<?= $product['name'] ?>" id="ad-pd-ed-name" onkeyup="validateNotEmpty(this, 'Product name');">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="content" class="form-control" placeholder="Ghi mô tả" rows="5" style="height:140px"><?= $product['description'] ?></textarea>
            </div>
        ...
        <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                <input value="<?= number_format($product['price'], 2, '.', '') ?>" type="number" class="form-control" step="0.01" name="price" placeholder="Nhập giá" id="ad-pd-ed-price" onkeyup="validateFloat(this, 'Price', 0.01);">

            </div>

            <div class="form-group">
                <label for="sale_price" style="display:inline-block">Giá đã giảm</label> &nbsp; <small class="notice">0 là không giảm</small>
                <small id="ad-pd-ed-sale_price-err"></small>
                <input value="<?= number_format($product['sale_price'], 2, '.', '') ?>" type="number" step="0.01" class="form-control" name="sale_price" placeholder="Nhập giá giảm" id="ad-pd-ed-sale_price" onkeyup="validateSalePrice(this, 'ad-pd-ed-price');">
            ...
            <div class="form-group">
                ...
                <input value="<?= $product['quantity'] ?>" type="number" class="form-control" name="quantity" placeholder="Nhập số lượng" id="ad-pd-ed-quantity" onkeyup="validateInt(this, 'Quantity');">
            </div>
