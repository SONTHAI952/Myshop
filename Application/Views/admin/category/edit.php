...
<form action="./?module=admin&controller=category&action=update&id=<?= $_GET['id'] ?>" method="POST" role="form" name="categoryForm" onsubmit="return validateCategoryForm();">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" placeholder="Nhập tên danh mục" value="<?= $category['name'] ?>" id="ad-ctg-cr-name" onkeyup="validateNotEmpty(this, 'Category name');">
    ...
    <div class="form-group">
        ...
        <!-- <div class="form-group">
            ...
            <input type="number" value="1" class="form-control" name="priority" placeholder="" <?= $category['priority'] ?> id="ad-ctg-cr-priority" onkeyup="validateInt(this, 'Priority');">
