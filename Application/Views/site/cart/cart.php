        ...
        <table class="table cart-table">
                    ...
                    <tr id="cart-item-<?= $item['id'] ?>" class="cart-item-class">
                        ...
                        <td>
                            <h5 id="prod-overall-price<?= $item['id'] ?>">
                                <?= number_format($item['price_sum']) ?> &#273;</h5>
            ...
            <tfoot>
                <tr>
                    ...
                    <td colspan="2">
                        <h4 id="total-in-cart">Tổng đơn: <?= number_format($cart->total_price) ?> &#273;</h4>
                    </td>
                </tr>
        ...
        <table class="order-info-table" style="width: 100%;">
            <tbody>
                <!-- <tr>
                    ...
                    <td><span class="price" id="sub-total-price">$<?= number_format($cart->total_price) ?></span></td>
                </tr> -->
                ...
                <tr>
                    ...
                    <td>
                        <?php if (isset($coupon)) : ?>
                            <?php if ($coupon != 0) : ?>
                                <span class="price" id="total-price">$<?= number_format($cart->total_price * (1 - $coupon)) ?> &#273;</span>
                    </td>
                <?php endif; ?>
                <?php if ($coupon == 0) : ?>
                    <span class="price" id="total-price"><?= number_format($cart->total_price) ?></span>

                <?php endif; ?>
            <?php else : ?>
                <span class="price" id="total-price"><?= number_format($cart->total_price) ?> &#273;</span>
            <?php endif; ?>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-right">
                        <a href="./?controller=checkout" class="btn-root ptc-btn border-root">Thanh toán</a>
                    </td>
                </tr>
            </tfoot>
        </table>
