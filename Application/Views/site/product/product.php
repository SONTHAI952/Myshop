                        ...
                        <?php foreach ($top_products as $pro) : ?>
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="discount-price"><?= number_format($pro['sale_price'] > 0 ? $pro['sale_price'] : $pro['price']) ?> &#273;</p>
                                    <?php if ($pro['sale_price'] > 0) : ?>
                                        <p class="old-price"><?= number_format($pro['price']) ?> &#273;</p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endforeach; ?>
                            ...
                            <li>
                                <a href="./?controller=product&action=productDetail&id=<?= $product['id'] ?>">
                                    <div class="pro-block">
                                        ...
                                        <div class="pro-info">
                                            <h5><?= $product['name'] ?? '' ?></h5>
                                            <h5><?= number_format($product['sale_price'] > 0 ? $product['sale_price'] : $product['price']) ?> &#273;</h5>
                                        </div>
                                    </div>
                                </a>
