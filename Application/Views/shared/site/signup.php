...
<div id="id02" class="modal">
    <form action="?controller=verify&action=signup" method="post" class="modal-content modal-dialog animate modal-dialog-centered" name="signupForm" onsubmit="return validateSignupForm();">
        ...
        <div class="main-form-content">
            ...
            <label for="province">Thành phố/ Huyện</label>
            ...
            <p class="text-center" style="margin-bottom: 0; margin-top: 16px">Đăng ký và đồng ý với
                <a href="#" style="color:var(--primary-color)">Điều khoản của chúng tôi</a>.
            </p>
