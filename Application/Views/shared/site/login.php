...
if (!empty($_SESSION['user'])) {
    ...
    <?php if ($user_session['role'] == 'admin') : ?>
        <a href='?module=admin&controller=customer&controller=dashboard'>
            <button class='login-modal' style='width:auto'><i class="fas fa-user-cog" style='font-size: 14px'></i>Chuyển tới quản trị</button>
        </a>
    <?php endif; ?>
    <a href='?controller=customer&action=viewProfile'>
        <button class='login-modal' style='width:auto'><i class='fas fa-user-edit' style='font-size: 14px'></i>Tài khoản</button>
    </a>
    <a href='?controller=customer&action=listOrders'>
        <button class='login-modal' style='width:auto'><i class='fas fa-receipt' style='font-size: 14px'></i>Lịch sử đơn</button>
    </a>
        ...
        <div class="row">
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                <div class="img-container">
                    <img src="./public/site/img/login-signup/login-banner.png" alt="Avatar" class="avatar">
                </div>
            </div>
            ...
            <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                <div class="main-form-content">
                    ...
                    <h5 class="text-center">Chào mừng quay lại !</h5>
                    <p class="text-center" style="margin-bottom: 3rem;">Nhập thông tin vào bên dưới</p>
